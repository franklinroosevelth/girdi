                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <br>
                      <center> <h4>Voulez-vous vraiment supprimer cette plainte ?</h4>  <br>
                        <a href="../controleurs/action_dynamique/supprimer_entite.php?nom_entite=plainte&entite_id=<?php echo $_GET['id'];?>" class="btn btn-primary mr-2">Oui, j'accepte</a>
                        <a href="liste_plaintes.php" class="btn btn-primary mr-2">Non, je retourne</a>
                        <br><br>
                      <center>
                    </form>
                  </div>
