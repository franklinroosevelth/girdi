                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <br>
                      <center> <h4>Votre demande a été envoyée avec succès</h4>  <br>
                        <a href="envoyer_demande_immatriculation.php" class="btn btn-primary mr-2">Retourner sur la page de demande</a>
                        <br>
                      <center>
                    </form>
                  </div>
