                    ...
                    success: function(response) 
                    {
                      ...
                      { 
                        if(response[i].vehicule_numero_plaque != null)
                        {
                          ...
                          +'</td><td>'+response[i].vehicule_numero_plaque+'</td><td>'
                          +response[i].vehicule_numero_chassis+'</td><td>'
                          ...
                          response[i].vehicule_date_immatriculation+'</td><td>'+
                          response[i].vehicule_create_datetime+'</td><td><a href="confirmer_suppression_plainte.php?id='+response[i].demande_immatriculation_id+'">Supprimer</a> <a href="affecter_plaque.php?id='+response[i].vehicule_id+'">Affecter</a></td></tr>';
                          j++;
                        }
                      }
