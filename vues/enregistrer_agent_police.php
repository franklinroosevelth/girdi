        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row "><div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="">Enregistrer un agent de la police</h4>
                    <form class="forms-sample" method="post" action="../controleurs/action_dynamique/enregistrer_agent.php?categorie=1">
                ...
                $.ajax(
                  {
                    ...
                    success: function(response) 
                    {
                      ...
                      {
                        if(response[i].agent_categorie==1)
                        {
                          ...
                          response[i].agent_telephone+'</td><td>'+
                          response[i].agent_adresse+'</td><td><a href="confirmer_suppression_agent.php?id='+
                          response[i].agent_id+'&categorie=1">Supprimer</a></td></tr>';
                        }
                      }
