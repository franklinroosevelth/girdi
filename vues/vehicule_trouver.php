        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row "><div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4>Signaler un véhicule trouvé</h4>
                    <form class="forms-sample" method="post" action="../controleurs/action_dynamique/enregistrer_vehicule_trouver.php" >
                    <div class="form-group" style="display:none;">
                        <input type="text"  name="recherche_id" value="<?php echo $_GET['id'];?>">
                      </div>
                    <div class="form-group">
                        <label for="exampleInputName2">Date d'arrestation</label>  
                        <input type="date" class="form-control" id="exampleInputName1" style="color:#fff"  name="vehicule_retrouve_date" required>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputName2">Nom de l'agent</label>  
                        <select type="text" class="form-control agent_id" id="exampleInputName1" style="color:#fff;"  name="agent_id" required>
                        </select>  
                      </div>
