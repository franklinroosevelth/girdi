        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row "><div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4>Enregistrer un avis de recherche</h4>
                    <form class="forms-sample" method="post" action="../controleurs/action_dynamique/enregistrer_recherche.php" >
                    <div class="form-group" style="display:none;">
                        <label for="exampleInputName2" >Date de disparition</label>  
                        <input type="text"  name="plainte_id" value="<?php echo $_GET['id'];?>">
                      </div>
                    <div class="form-group">
                        <label for="exampleInputName2">Date de disparition</label>  
                        <input type="date" class="form-control" id="exampleInputName1" style="color:#fff"  name="recherche_date_disparition" required>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputName2">Saisisser la cause</label>  
                        <textarea type="text" class="form-control" id="exampleInputName1" style="color:#fff; height:70px" placeholder="Décrivez la cause" name="recherche_cause_disparition" required></textarea>
                      </div>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Liste  des avis de recherche </h4>
                ...
                $.ajax(
                  {
                    ...
                    dataType:"json",
                    data:{nom_entite:"recherche", designation:""},
                    success: function(response) 
                    {
                      ...
                      { 
                        ...
                        +response[i].recherche_cause_disparition+'</td><td>'+
                        response[i].recherche_create_datetime+'</td><td><a href="vehicule_trouver.php?id='+
                        response[i].recherche_id+'">Signaler</a></td></tr>';
                        j++;
                      }
