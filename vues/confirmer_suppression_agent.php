                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <br>
                      <center> <h4>Voulez-vous vraiment supprimer cet agent ?</h4>  <br>
                        <a href="../controleurs/action_dynamique/supprimer_entite.php?nom_entite=agent&entite_id=<?php echo $_GET['id'];?>&categorie=<?php echo $_GET['categorie'];?>" class="btn btn-primary mr-2">Oui, j'accepte</a>
                        <?php 
                          $page = "enregistrer_agent_police.php";
                          if($_GET['categorie'] == 2)
                            $page = "enregistrer_agent_dgi.php";
                        ?>
                        <a href="<?php echo $page ?>" class="btn btn-primary mr-2">Non, je retourne</a>
                        <br><br>
                      <center>
                    </form>
                  </div>
